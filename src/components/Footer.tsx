    ...
    <footer className="bg-brand-text text-white" role="contentinfo">
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="font-dm tracking-[0.18em] uppercase mb-8 text-[13px] text-[#C8A876]">
          ...
          <a
            ...
            className="pulse-wa btn-shimmer inline-flex items-center gap-2.5 rounded-full bg-white text-[#2C2C2C] font-dm font-semibold text-sm hover:bg-[#C8A876] transition-colors duration-500 w-full max-w-xs sm:w-auto will-change-transform"
          >
